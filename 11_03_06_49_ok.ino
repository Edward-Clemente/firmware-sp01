...
const String VERSAO_ATUAL = "1.0.9";
...
const char* WIFI_SSID = "Edward";
const char* WIFI_PASS = "MAGMAG123";
...
void loop() {
  ...
  if (estado == PRONTO) {
    ...
    if (millis() - tDados > INTERVALO_ATUALIZACAO_PAINEL) {
      ...
      //tft.setTextSize(2);
      tft.fillRect(0, 196, 130, 20, 0x0000);  // limpa só a área do menu
      tft.setCursor(10, 198);
      tft.setTextSize(2);
      ...
      tft.fillRect(0, 222, 130, 18, 0x0000);
...
/////////////////////////////////////////////////  FIM da PARTE 4/4 ( FIM DO CÓDIGO )  ////////////////////////////////////////////////////